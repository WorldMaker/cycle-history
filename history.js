...
function historyDriver(request$) {
    ...
    var popState$ = rx.Observable.fromEventPattern(function (h) { return window.addEventListener('onpopstate', h); }, function (h) { return window.removeEventListener('onpopstate', h); })
